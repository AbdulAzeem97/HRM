...
use App\Http\Controllers\OvertimeCalculationController;
...
use App\Http\Controllers\LaborPayrollController;
...
Route::group(['middleware' => ['XSS','checkDataTable']], function () {
    ...
    Route::prefix('staff')->group(function () {
        ...
        Route::prefix('employees')->group(function () {
            ...
            // Specific routes must come before the generic {employee} route
            ...
            Route::post('{employee}/overtime_settings_update', [EmployeeController::class, 'employeesOvertimeSettingsUpdate'])->name('employees.overtime_settings_update');
    ...
    Route::prefix('report')->group(function () {
        ...
        // Enhanced Attendance Rules Routes
        Route::get('daily_attendance_enhanced', [AttendanceController::class, 'getDailyAttendanceReport'])->name('report.daily_attendance_enhanced');
        Route::get('extra_ot_report', [AttendanceController::class, 'getExtraOTReport'])->name('report.extra_ot_report');
        Route::get('attendance_summary', [AttendanceController::class, 'getAttendanceSummary'])->name('report.attendance_summary');
        //New Added
    ...
    Route::prefix('timesheet')->group(function () {
        ...
        Route::get('attendances/bulk-upload', [AttendanceController::class, 'bulkUpload'])->name('attendance.bulk-upload');
        Route::post('attendances/bulk-upload', [AttendanceController::class, 'bulkUploadStore'])->name('attendance.bulk-upload.store');
        Route::get('attendances/debug-employees', [AttendanceController::class, 'debugEmployees'])->name('attendance.debug-employees');
        Route::get('attendances/upload-user-data', [AttendanceController::class, 'uploadUserData'])->name('attendance.upload-user-data');
    ...
    Route::prefix('labor')->name('labor.')->group(function () {
        ...
        Route::prefix('payroll')->name('payroll.')->group(function () {
            Route::get('/', [LaborPayrollController::class, 'index'])->name('index');
            Route::post('/process', [LaborPayrollController::class, 'processBulkPayroll'])->name('process');
            Route::get('/report', [LaborPayrollController::class, 'generatePaymentReport'])->name('report');
            Route::post('/bulk-payment', [LaborPayrollController::class, 'processBulkPayments'])->name('bulk-payment');
        });
    });

    // API Routes for Labor Management
    Route::prefix('api/labor')->group(function () {
    ...
    Route::prefix('overtime-calculations')->name('overtime.calculations.')->group(function () {
        ...
        Route::get('/{overtimeCalculation}', [OvertimeCalculationController::class, 'show'])->name('show');
        Route::delete('/{overtimeCalculation}', [OvertimeCalculationController::class, 'destroy'])->name('destroy');

        // API endpoints for processing
        Route::post('/process-range', [OvertimeCalculationController::class, 'processRange'])->name('process.range');
        Route::post('/recalculate-month', [OvertimeCalculationController::class, 'recalculateMonth'])->name('recalculate.month');
        Route::post('/verify', [OvertimeCalculationController::class, 'verify'])->name('verify');
        Route::post('/mark-paid', [OvertimeCalculationController::class, 'markPaid'])->name('mark.paid');
        Route::post('/auto-process', [OvertimeCalculationController::class, 'autoProcess'])->name('auto.process');
        Route::post('/bulk-delete', [OvertimeCalculationController::class, 'bulkDelete'])->name('bulk.delete');

        // Reports and exports
        Route::get('/payroll-summary', [OvertimeCalculationController::class, 'payrollSummary'])->name('payroll.summary');
        Route::get('/report', [OvertimeCalculationController::class, 'report'])->name('report');
        Route::get('/export', [OvertimeCalculationController::class, 'export'])->name('export');
    });

    // API Routes for Overtime Calculations
    Route::prefix('api/overtime')->group(function () {
