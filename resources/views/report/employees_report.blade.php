    ...
    <section class="dashboard">
        <div class="container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">{{__('Employee Reports')}}</h1>
                <p class="page-subtitle">{{__('Generate and view detailed employee reports')}}</p>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card card mb-4">
                        <div class="card-header">
                            <h3 class="card-title"> {{__('Filter Employee')}} </h3>
                        </div>
                        <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
