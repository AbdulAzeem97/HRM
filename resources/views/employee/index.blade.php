...
@section('content')
    ...
    <section class="dashboard">
        ...
        <div class="page-header">
            <h1 class="page-title">{{__('Employee Management')}}</h1>
            <p class="page-subtitle">{{__('Manage your organization employees')}}</p>
        </div>

        <div class="container-fluid mb-3">
            @can('store-details-employee')
                <button type="button" class="btn btn-primary btn" name="create_record" id="create_record"><i
                            class="fa fa-plus"></i> {{__('Add Employee')}}</button>
            @endcan
            @can('modify-details-employee')
                <button type="button" class="btn btn-danger btn" name="bulk_delete" id="bulk_delete"><i
                            class="fa fa-minus-circle"></i> {{__('Bulk delete')}}</button>
            @endcan
            <button class="btn btn-info btn" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
