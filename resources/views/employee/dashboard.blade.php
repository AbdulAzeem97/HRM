                                            ...
                                            <form method="post" id="basic_sample_form" class="form-horizontal"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        ...
                                                        <input type="text" name="nic_expiry" id="contact_nic_expiry" placeholder="DD-MM-YYYY" value="{{$employee->nic_expiry ? date('d-m-Y', strtotime($employee->nic_expiry)) : ''}}" class="form-control date datepicker">
                                                    </div>
