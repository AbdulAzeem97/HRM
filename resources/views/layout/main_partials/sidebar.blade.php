<nav class="side-navbar side-navbar">
    <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled mb-5">
                ...
                @can('view-details-employee')
                    <li class="has-dropdown {{ (request()->is('labor*')) ? 'active' : '' }}">
                        <a href="#labor_management" aria-expanded="false" data-toggle="collapse">
                            <i class="dripicons-user-id"></i><span>{{__('Labor Management')}}</span>
                        </a>
                        <ul id="labor_management" class="collapse list-unstyled ">
                            <li id="labor_employees"><a href="{{route('labor.index')}}">{{__('Labor Employees')}}</a></li>
                            <li id="add_labor"><a href="{{route('labor.create')}}">{{__('Add Labor Employees')}}</a></li>
                            <li id="labor_attendance"><a href="{{route('labor.attendance')}}">{{__('Process Attendance')}}</a></li>
                        </ul>
                    </li>
                @endcan
