...
@section('content')
    ...
    <section class="dashboard">
        ...
        <div class="page-header">
            <h1 class="page-title">{{__('Leave Management')}}</h1>
            <p class="page-subtitle">{{__('Manage employee leave requests and approvals')}}</p>
        </div>
        ...
        <div class="card card">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="leave-table" class="table table">
                <thead>
                <tr>
