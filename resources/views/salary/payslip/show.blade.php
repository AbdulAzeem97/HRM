                                            ...
                                            <div class="table-responsive">
                                                <table class="table  table-bordered dataTable no-footer">
                                                    ...
                                                    @foreach($payslip->allowances as $allowance)
                                                        ...
                                                        @php
                                                            $allowance_total += (float) ($allowance['allowance_amount'] ?? 0)
                                                        @endphp
                                                    @endforeach
                                                    <tr>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table  table-bordered dataTable no-footer">
                                                    ...
                                                    @foreach($payslip->commissions as $commission)
                                                        ...
                                                        @php
                                                            $commission_total += (float) ($commission['commission_amount'] ?? 0)
                                                        @endphp
                                                    @endforeach
                                                    <tr>
                                                        <td><strong>{{trans('file.Total')}}:</strong> <span
                                            ...
                                            <div class="table-responsive">
                                                <table class="table  table-bordered dataTable no-footer">
                                                    ...
                                                    @foreach($payslip->loans as $loan)
                                                        ...
                                                        @php
                                                            $loan_total += (float) ($loan['monthly_payable'] ?? 0)
                                                        @endphp
                                                    @endforeach
                                            ...
                                            <div class="table-responsive">
                                                <table class="table  table-bordered dataTable no-footer">
                                                    ...
                                                    @foreach($payslip->deductions as $deduction)
                                                        ...
                                                        @php
                                                            $deduction_total += (float) ($deduction['deduction_amount'] ?? 0)
                                                        @endphp
                                            ...
                                            <div class="table-responsive">
                                                <table class="table  table-bordered dataTable no-footer">
                                                    ...
                                                    @foreach($payslip->other_payments as $other_payment)
                                                        ...
                                                        @php
                                                            $other_payment_total += (float) ($other_payment['other_payment_amount'] ?? 0)
                                                        @endphp
                                                    @endforeach
                                                    <tr>
                                                        <td><strong>{{trans('file.Total')}}:</strong> <span
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered mb-0">
                                                    ...
                                                    @foreach($payslip->overtimes as $overtime)
                                                        ...
                                                        @php
                                                            $overtime_total += (float) ($overtime['overtime_amount'] ?? 0)
                                                        @endphp
                                                    @endforeach
                                                    </tbody>
                                                    <tfoot>
