...
@section('content')
    ...
    <section class="dashboard-counts">
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb-30px page-header">
                <div><h1 class="thin-text page-title">{{trans('file.Welcome')}} {{auth()->user()->username}}</h1></div>
                <div><h4 class="thin-text page-subtitle">{{__('Today is')}} {{now()->englishDayOfWeek}} {{now()->format(env('Date_Format'))}}</h4></div>
            </div>
